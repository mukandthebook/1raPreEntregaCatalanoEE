...
if(pago=="tarjeta"){
    ...
    if(debOcred== "credito"){
        ...
        else if(cuotas==6){KilogramosCuota= totalTotal/cuotas
         console.log("6 cuotas sin intereses de: $"+ KilogramosCuota)
        }

        else if(cuotas ==12){KilogramosCuota= totalTotal/cuotas
         console.log("12 cuotas sin intereses de: $"+ KilogramosCuota)
        }
        
        else{alert("opcion invalida, vuelva a comenzar la compra")
        }

    }

    else if(debOcred=="debito") {datosTarjeta=Number(prompt("ingrese los 12 digitos de su tarjeta"))
         if(datosTarjeta>=123456789100 && datosTarjeta<=123456789100);
...
else if(pago=="transferencia") {alert("CBU NRO. 123123456646777 a nombre de El Patron de los Animales")
